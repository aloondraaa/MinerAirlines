...
/**
 * Class that receives attributes from the Flight Class and contains a constructor for the attributes
 */
public class International extends Flight {
     ...
     */
    public International(int flightIDIn, int flightNumberIn, String originAirportIn, String originCodeIn, String originAirportCityIn, String originAirportStateIn,
